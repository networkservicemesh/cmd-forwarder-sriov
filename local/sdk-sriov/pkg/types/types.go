...
// Package types define different structs
package types
...
type ResourceConfig struct {
	RegistryDomainName string `json:"registryDomainName"`
	Capability         string `json:"capability"`
	DevicePciAddress   string `json:"devicePciAddress"`
	ConnectedToPort    string `json:"connectedToPort"`
}
